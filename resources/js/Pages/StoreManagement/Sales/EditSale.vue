...
export default {
    ...
    props: ['sales','products','productsHasEntries','productsHasCategories','categories','customers','myStores'],
    data() {
        return {
            form: {
                stores_id: this.sales[0].stores_id,
                type_sell: this.sales[0].type,
                customers_id: this.sales[0].customers_id,
                description: this.sales[0].description,
                productsToSell: [{
                    products_id: '',
                    qty: '1',
                    unity_price: '0',
        ...
        setProductsInSale(){
            ...
            this.sales.forEach(e => {
                array.push({
                    ...
                    qty: this.sales.length > 1 ? (this.sales.filter(x => x.products_id == e.products_id).length).toString() : '1',
            ...
            this.form.productsToSell = array
        },
        getMaxQtyInStock(id){

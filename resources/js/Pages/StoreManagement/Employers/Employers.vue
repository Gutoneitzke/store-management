        ...
        <PageCard>
            ...
            <table class="table-auto w-full mt-8 divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <tr v-for="s,i in employers" :key="i">
                        <td 
...
export default {
    ...
    methods: {
        deleteEmployee(id){
            ...
            if(status){
                this.$inertia.delete(route("employers.destroy", id));
            } 
        }
    }
}
